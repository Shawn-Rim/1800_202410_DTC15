...
function extractInstructions(form) {
  return form.getAll("instruction")
...
function extractIngredeints(form) {
  ...
  const quantities = form.getAll("ingredient-quantity").map(quantity => parseInt(quantity.trim()));
...
function addInstruction() {
  ...
  instantiation.querySelector("button").addEventListener("click", () => removeElementAt(instructions, index));
...
function addIngredient() {
  ...
  instantiation.querySelector("button").addEventListener("click", () => removeElementAt(ingredients, index));
